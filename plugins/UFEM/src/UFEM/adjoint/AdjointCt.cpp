      ...
      (
        _A = _0, _T = _0, _a = _0,
          ...
          (
                  ...
                  _a[U[_i]] += transpose(N(U) -tau_su*u*nabla(U)) * lit(3.0) / lit(2.0) * lit(m_ct[0]) * uDisk[_i] * uDisk[_i] / lit(m_th)  /* -transpose(N(U) - tau_su*u*nabla(U)) * lit(3.0) * g[_i] * density_ratio + */
                            - transpose(N(U) -tau_su*u*nabla(U)) * lit(m_U_mean_disk) * lit(m_ct[0]) * uDisk[0] / lit(m_th)
